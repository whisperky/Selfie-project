...
export const protectedRoutes = [
    ...
    },
    {
        ...
        component: React.lazy(() => import('views/app-views/management/usermanage')),
    },
    {
        key: 'management.accountManagement',
        path: `${APP_PREFIX_PATH}/management/account`,
        component: React.lazy(() => import('views/app-views/management/accountmanage')),
    },
    {
        key: 'management.employeeManagement',
        path: `${APP_PREFIX_PATH}/management/employee`,
        component: React.lazy(() => import('views/app-views/management/employeemanage')),
    },
    {
        key: 'management.selfiemanage.list',
        path: `${APP_PREFIX_PATH}/management/selfies/lists`,
        component: React.lazy(() => import('views/app-views/management/selfiemanage/list')),
    },
    {
