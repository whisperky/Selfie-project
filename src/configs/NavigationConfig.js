  ...
  submenu: [
    {
      ...
      title: 'sidenav.management.userManagement',
      icon: TeamOutlined,
      breadcrumb: false,
      submenu: []
    },
    {
      ...
      path: `${APP_PREFIX_PATH}/management/account`,
      title: 'sidenav.management.accountManagement',
    ...
    },
    {
      ...
      path: `${APP_PREFIX_PATH}/management/employee`,
      title: 'sidenav.management.employeeManagement',
      icon: HomeOutlined,
      breadcrumb: false,
      submenu: []
    },
    {
      key: 'selfies-management',
      path: `${APP_PREFIX_PATH}/management/selfies`,
      title: 'sidenav.management.selfieManagement',
      icon: FileImageOutlined,
      breadcrumb: false,
      submenu: [
        {
          key: 'management-selfie-list',
          path: `${APP_PREFIX_PATH}/management/selfies/lists`,
          title: 'sidenav.management.selfieManagement.lists',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'management-selfie-action',
          path: `${APP_PREFIX_PATH}/management/selfies/actions`,
          title: 'sidenav.management.selfieManagement.actions',
          icon: '',
          breadcrumb: false,
          submenu: []
        }
    ...
    },
    {
      ...
      path: `${APP_PREFIX_PATH}/management/payment`,
      title: 'sidenav.management.paymentManagement',
      icon: EuroCircleOutlined,
      breadcrumb: false,
      submenu: [
        {
          key: 'management-payment-transactions',
          path: `${APP_PREFIX_PATH}/management/payment/transactions`,
          title: 'sidenav.management.paymentManagement.transactions',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'management-payment-actions',
          path: `${APP_PREFIX_PATH}/management/payment/actions`,
          title: 'sidenav.management.paymentManagement.actions',
          icon: '',
          breadcrumb: false,
          submenu: []
        }
    ...
    },
    {
      ...
      path: `${APP_PREFIX_PATH}/management/verification`,
      title: 'sidenav.management.verificationManagement',
      icon: IdcardOutlined,
      breadcrumb: false,
      submenu: [
        {
          key: 'management-verification-personalInfo',
          path: `${APP_PREFIX_PATH}/management/verification/personalInfo`,
          title: 'sidenav.management.verificationManagement.personalInfo',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'management-verification-paymentInfo',
          path: `${APP_PREFIX_PATH}/management/verification/paymentInfo`,
          title: 'sidenav.management.verificationManagement.paymentInfo',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'management-verification-identity',
          path: `${APP_PREFIX_PATH}/management/verification/identity`,
          title: 'sidenav.management.verificationManagement.identity',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'management-verification-legaldoc',
          path: `${APP_PREFIX_PATH}/management/verification/legalDocument`,
          title: 'sidenav.management.verificationManagement.legalDocument',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
    ...
    {
      key: 'referrals-management',
      path: `${APP_PREFIX_PATH}/management/referrals`,
      title: 'sidenav.management.referralsManagement',
      icon: GiftOutlined,
      breadcrumb: false,
      submenu: [
        {
          key: 'management-referrals-user',
          path: `${APP_PREFIX_PATH}/management/referrals/user`,
          title: 'sidenav.management.referralsManagement.user',
          icon: '',
          breadcrumb: false,
          submenu: []
        },
        {
          key: 'management-referrals-private',
          path: `${APP_PREFIX_PATH}/management/referrals/private`,
          title: 'sidenav.management.referralsManagement.private',
          icon: '',
          breadcrumb: false,
          submenu: []
        }
