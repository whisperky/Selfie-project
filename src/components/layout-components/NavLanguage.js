...
const SelectedLanguage = () => {
	...
	return (
		<Flex alignItems="center">
			<CircleFlag countryCode={`${icon}`} height="25" alt={langName} />
		...
		<span>
			...
			>
				<Flex alignItems="center" gap={SPACER[2]}>
					<CircleFlag countryCode={`${props.icon}`} height="25" alt={props.langName} />
...
const items = [
	...
	{
		key: 'Nl',
		label: <MenuItem icon="nl" langName="Nederlands" langId="nl" />
	},
	{
		key: 'Ua',
		label: <MenuItem icon="ua" langName="Россия" langId="ua" />
	},
	{
		key: 'Ch',
