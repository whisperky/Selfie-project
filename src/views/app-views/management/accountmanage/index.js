...
export class UserList extends Component {
  ...
  handleStatus = (user, newStatus) => {
    const newUser = { ...user, accountStatus: newStatus };
    axios
      .post("http://localhost:5000/api/management/changeStatus", newUser)
      .then((res) => {
      ...
      },
      {
        ...
        render: (_, elm) => (
          <Tag
            ...
            color={
              elm.accountStatus === "active"
                ? "cyan"
                : elm.accountStatus === "pending"
                ? "blue"
                : "red"
            }
          >
