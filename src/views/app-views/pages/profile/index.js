			...
			<Col sm={24} md={23}>
				<div className="d-md-flex">
					<div className="rounded p-2 bg-white shadow-sm mx-auto" style={{'marginTop': '-3.5rem', 'maxWidth': `${props.avatarSize + 16}px`}}>
						<Avatar shape="square" size={props.avatarSize} src="/img/avatars/artem.png" />
					</div>
					<div className="ml-md-4 w-100">
						<Flex alignItems="center" mobileFlex={false} className="mb-3 text-md-left text-center">
							<h2 className="mb-0 mt-md-0 mt-2">Artem Panchina</h2>
						...
						<Row gutter="16"> 
							...
							<Col xs={24} sm={24} md={8}>
								<Row className="mb-2"> 
									...
									<Col xs={12} sm={12} md={15}>
										<span className="font-weight-semibold">skyangel0421@gmail.com</span>
									</Col>
								</Row>
								<Row> 
									<Col xs={12} sm={12} md={9}>
							...
							<Col xs={24} sm={24} md={8}>
								<Row className="mb-2 mt-2 mt-md-0 "> 
									...
									<Col xs={12} sm={12} md={15}>
										<span className="font-weight-semibold">Sheridan, WY 82801, US</span>
									</Col>
								</Row>
								<Row className="mb-2"> 
									<Col xs={12} sm={12} md={9}>
									...
									<Col xs={12} sm={12} md={15}>
										<span className="font-weight-semibold">https://brainwavehq.org/</span>
									</Col>
								</Row>
							</Col>
						</Row>
