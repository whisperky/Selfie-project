...
import RevenueWidget from 'components/shared-components/RevenueWidget';
...
export const DefaultDashboard = () => {
  ...
  const [annualRevenueStatisticData] = useState(CurrentRevenueStatisticData);
    ...
    <>
      <Row gutter={16}>
        <Col xs={24} sm={24} md={24} lg={18}>
          ...
          <Row gutter={16}>
            {
              annualRevenueStatisticData.map((elm, i) => (
